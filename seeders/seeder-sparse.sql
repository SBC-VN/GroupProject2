...
INSERT INTO users (firstname, lastname, screenname, password, sentimentScore, email, age, locale, profilepic, bio) VALUES ('fifth',"user", "user5","one",1, "email5", 109, "LostAndfoundland", "werry.jfif", "Your'e a lizard, Warry!");
INSERT INTO users (firstname, lastname, screenname, password, sentimentScore, email, age, locale, profilepic, bio) VALUES ('sixth',"user", "user6","one",1, "email6", 109, "NeverNeverLand", "burgerpic.jpg", "Spam Spam Spam Spam... Spam Spam Spam Spam.... Spammmity Spam! Spammity Spam Spam Spam!");
